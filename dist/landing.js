...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("features-link").addEventListener("click", () => smoothScroll("features-section"));
    document.getElementById("operations-link").addEventListener("click", () => smoothScroll("operations-section"));
    document.getElementById("testimonials-link").addEventListener("click", () => smoothScroll("testimonials-section"));
});
